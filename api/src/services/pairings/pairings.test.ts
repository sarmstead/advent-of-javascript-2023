...
describe('pairings', () => {
  ...
  scenario('creates a pairing', async (scenario: StandardScenario) => {
    const result = await createPairing({
      input: {
        ...
        updatedAt: '2023-12-07T23:20:01.921Z',
      },
    })
    ...
    expect(result.updatedAt).toEqual(new Date('2023-12-07T23:20:01.921Z'))
  })
  ...
  scenario('updates a pairing', async (scenario: StandardScenario) => {
    ...
    const result = await updatePairing({
      id: original.id,
      input: { updatedAt: '2023-12-08T23:20:01.922Z' },
    })

    expect(result.updatedAt).toEqual(new Date('2023-12-08T23:20:01.922Z'))
  })
